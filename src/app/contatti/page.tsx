            ...
            <aside className="lg:col-span-4 space-y-5">
              <div className="border border-gray-light rounded-sm overflow-hidden">
                <div className="h-56 bg-gray-light flex items-center justify-center">
                  <span className="text-gray-mid text-sm font-inter">Foto referente (placeholder)</span>
                </div>
                <div className="p-5">
                  <p className="text-xs uppercase tracking-widest text-red font-inter font-semibold mb-2">
                    Referente corsi
                  </p>
                  <h2 className="font-cinzel text-2xl text-black font-semibold mb-2">
                    Sifu Cristiano
                  </h2>
                  <p className="text-gray-mid text-sm font-inter leading-relaxed">
                    Responsabile informazioni iscrizioni, orientamento ai corsi e supporto ai nuovi praticanti.
                  </p>
                </div>
              </div>

              <div className="bg-gray-light rounded-sm p-5 space-y-4">
                <a href="tel:+393388466400" className="flex items-center gap-3 text-black hover:text-red transition-colors">
                  ...
                  <div>
                    ...
                    <p className="font-inter font-semibold">338 846 6400</p>
                  </div>
                </a>

                <a href="mailto:info@kungfucomo.org" className="flex items-center gap-3 text-black hover:text-red transition-colors">
                  <span className="w-9 h-9 rounded-full bg-red/10 text-red flex items-center justify-center">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="font-inter font-semibold">info@kungfucomo.org (placeholder)</p>
                  </div>
                </a>
              </div>
            </aside>
